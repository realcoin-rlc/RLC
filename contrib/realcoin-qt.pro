...
RESOURCES += src/qt/realcoin.qrc src/qt/realcoin_locale.qrc

TRANSLATIONS += src/qt/locale/realcoin_bg.ts \
                src/qt/locale/realcoin_de.ts \
                src/qt/locale/realcoin_en.ts \
                src/qt/locale/realcoin_es.ts \
                src/qt/locale/realcoin_fi.ts \
                src/qt/locale/realcoin_fr.ts \
                src/qt/locale/realcoin_it.ts \
                src/qt/locale/realcoin_ja.ts \
                src/qt/locale/realcoin_pl.ts \
                src/qt/locale/realcoin_pt.ts \
                src/qt/locale/realcoin_ru.ts \
                src/qt/locale/realcoin_sk.ts \
                src/qt/locale/realcoin_sv.ts \
                src/qt/locale/realcoin_vi.ts \
                src/qt/locale/realcoin_zh_CN.ts \
                src/qt/locale/realcoin_zh_TW.ts
