...
This document provides guidelines for internationalization of the RealCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `realcoin_en.ts` remains unchanged.
