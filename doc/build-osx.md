...
1. Clone the RealCoin Core source code:
        ...
        git clone https://github.com/realcoin-project/realcoin
        cd realcoin
...
RealCoin Core is now available at `./src/realcoind`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/RealCoin"

    touch "/Users/${USER}/Library/Application Support/RealCoin/realcoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/RealCoin/realcoin.conf"

The first time you run realcoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/RealCoin/debug.log

Other commands:
-------

    ./src/realcoind -daemon # Starts the realcoin daemon.
    ./src/realcoin-cli --help # Outputs a list of command-line options.
    ./src/realcoin-cli help # Outputs a list of RPC commands when the daemon is running.
