...
* Update translations (ping Fuzzbawls on Discord) see [translation_process.md](https://github.com/RealCoin-Project/RealCoin/blob/master/doc/translation_process.md#synchronising-translations).
* Update manpages, see [gen-manpages.sh](https://github.com/realcoin-project/realcoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/realcoin-project/gitian.sigs.git
    git clone https://github.com/realcoin-project/realcoin-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/realcoin-project/realcoin.git

### RealCoin maintainers/release engineers, suggestion for writing release notes
...
- Detached signatures will then be committed to the [realcoin-detached-sigs](https://github.com/realcoin-Project/realcoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/RealCoin-Project/RealCoin/releases/new) with a link to the archived release notes.
