...
from fake_stake.base_test import RealCoin_FakeStakeTest

class zRLCwrappedSerialsTest(RealCoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zRLCs..." % DENOM_TO_USE)
