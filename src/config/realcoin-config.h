/* src/config/realcoin-config.h.  Generated from realcoin-config.h.in by configure.  */
/* src/config/realcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.real-coin.in"

/* Define to the full name of this package. */
#define PACKAGE_NAME "RealCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "RealCoin Core 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "realcoin"
