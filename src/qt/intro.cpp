...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("RealCoin Core"),
     ...
     * override -datadir in the realcoin.conf file in the default data directory
     * (to be consistent with realcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
