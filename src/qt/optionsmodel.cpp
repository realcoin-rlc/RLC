...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::RLC);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeRealCoinAmount"))
        SoftSetArg("-anonymizerealcoinamount", settings.value("nAnonymizeRealCoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in realcoin.cpp during shotdown to also remove the window positions
