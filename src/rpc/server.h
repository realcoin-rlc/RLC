...
extern UniValue DoZreaSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzreaseed(const UniValue& params, bool fHelp);
extern UniValue getzreaseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzrea(const UniValue& params, bool fHelp);
extern UniValue dzreastate(const UniValue& params, bool fHelp);
