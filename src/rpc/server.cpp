...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* RealCoin features */
        {"realcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"realcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"realcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"realcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"realcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"realcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"realcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"realcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"realcoin", "startmasternode", &startmasternode, true, true, false},
        {"realcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"realcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"realcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"realcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"realcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"realcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"realcoin", "preparebudget", &preparebudget, true, true, false},
        {"realcoin", "submitbudget", &submitbudget, true, true, false},
        {"realcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"realcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"realcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"realcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"realcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"realcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"realcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"realcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"realcoin", "mnsync", &mnsync, true, true, false},
        {"realcoin", "spork", &spork, true, true, false},
        {"realcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzrlcseed", &getzrlcseed, false, false, true},
        {"zerocoin", "setzrlcseed", &setzrlcseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzrlc", &searchdzrlc, false, false, true},
        {"zerocoin", "dzrlcstate", &dzrlcstate, false, false, true},
...
{
    return "> realcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:26913/\n";
}
