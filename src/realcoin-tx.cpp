...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("RealCoin Core realcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  realcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded realcoin transaction") + "\n" +
                               "  realcoin-tx [options] -create [commands]   " + _("Create hex-encoded realcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded realcoin transaction
