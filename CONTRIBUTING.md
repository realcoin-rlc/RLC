...
[Translation Process](https://github.com/realcoin-project/realcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the RealCoin Core project, and is not to be
confused with overall RealCoin Network Protocol consensus changes.
...
Where a patchset proposes to change the RealCoin consensus, it must have been
